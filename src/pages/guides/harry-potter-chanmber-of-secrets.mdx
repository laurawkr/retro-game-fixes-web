...
title: Harry Potter and the Chamber of Secrets (PC CD-ROM, US)
description: Step-by-step guide for running Harry Potter and the Chamber of Secrets on Windows XP, 7, 10, and 11
pageTitle: Harry Potter and the Chamber of Secrets (PC)
...
# How to Run *Harry Potter and the Chamber of Secrets* (PC CD-ROM, US) on Modern Windows

Follow this guide to get *Harry Potter and the Chamber of Secrets* (original PC CD-ROM, US version) running on **Windows XP, Windows 7, Windows 10, and Windows 11**

---

<AutoCarousel folder="harry-potter-chamber-of-secrets" intervalMs={3500} height={480} width={480} />
...
The PC version of HP2 was built for early DirectX and uses legacy **SafeDisc** copy protection. On modern systems:
...
1. Insert your original **Harry Potter and the Chamber of Secrets** PC CD-ROM.
...
1. If you are encountering safedisc issues this is where you will need to use your legal solution to the SafeDisc issue (e.g., an official re-release/digital version if available).
***Due to modern disc read speeds its unlikely you will be able to play the game from your original disc on windows 10 and 11, so you are often limitted until you find your legal solution. Several options are available and youtube videos exsist walking you throughg this final, easy step as well, I just must reitterate that you should use legal solutions only.
