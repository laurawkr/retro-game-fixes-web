...
***Due to modern disc read speeds its unlikely you will be able to play the game from your original disc on windows 10 and 11, so you are often limitted until you find your legal solution. Several options are available and youtube videos exsist walking you through this final, easy step. I just must reitterate that you should use legal solutions only.
