...
title: Sid Meier's Sim Golf (PC CD-ROM, US)
description: Step-by-step guide for running Sid Meier's Sim Golf on Windows XP, 7, 10, and 11
pageTitle: Sid Meier's Sim Golf (PC)
...
1. Insert your original **Sid Meier's Sim Golf** PC CD-ROM.
